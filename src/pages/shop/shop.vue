      ...
      <scroll-view  scroll-y="true" class="shop-model">
        <div>
          <div>
            ...
            <p>北鼻们签到一次能获得两种积分：
            <p></p>
            <p>1、<span style="color:red">排行积分</span>，排位积分用于起床活动排位赛，不受商城积分兑换商品券减少的影响，仅用于排位，且根据排位既定最后是否有资格参与最后大奖。 </p>
            <p>2、<span style="color:red">商城积分</span>，商城积分积累方式与排位积分相同，但商城积分可用于商城兑换商品，在兑换商品时会减少商城积分  （每件商品用户只能兑换一次）</p>
            
            <h2 class="h2">关于兑换：</h2>
            
            <p>1、商品兑换无日期限制，可持续到所有商品被兑换完毕，商品有效期将在商品详情页面呈现，用户可通过商品详情页查看，但是由于其他意外可能会暂时下架噢</p>
            <p>2、第一次兑换商品需要手机号呢（作为后续跟进以及兑换的凭证之一），这可以为以后我们给北鼻赠送或者补偿提供联络方式</p>
            <p></p>
            <h2 class="h2">关于使用：</h2>
            
            <p>1、北鼻兑换成功后，到对应的商铺去使用，向店员（或者我们的工作人员）出示该优惠券，并<span style="color:red">由店员点击使用按钮</span></p>
            <p>2、若是北鼻手误点了使用并确认使用，我们也无能为力呢~</p>
            <p>3、所以北鼻在兑换时请小心使用！</p>
            <p>-></p>
            <p>如果兑换失败或者其他问题，请及时在公众号向小北反馈噢</p>
            <p>-></p>
            <h2 class="h2" style="text-align:center">北理小报保留对以上规则的解释权</h2>
          </div>
      </div>
      </scroll-view>
    </modal>
